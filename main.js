...
function adivinhaNumero() {
  ...
  function getResultado() {
    if (tentativas == 1) {
      resultado.innerHTML = `Você é bom! De primeira! <strong style="color: red">Parabéns!</strong><br/>Mas... Será que não foi <strong style="color: rgb(250, 152, 29)">SORTE</strong>?<br/> Clique <a href="https://leticiapalaro.github.io/-_html-css-javascript_-jogo-de-adivinhacao/"><strong style="color: blue">AQUI</strong></a> para tentar novamente!`;
      console.log(chute);
    } else {
      resultado.innerHTML = `Você acertou em ${tentativas} tentativas! <strong style="color: red">Parabéns!</strong><br/>Clique <a href="https://leticiapalaro.github.io/-_html-css-javascript_-jogo-de-adivinhacao/"><strong style="color: blue">AQUI</strong></a> para tentar novamente!`;
    }
  }
